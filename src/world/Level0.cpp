...
bool ChatHandler::HandleInfoCommand(const char* args, WorldSession *m_session)
{
    ...
    GreenSystemMessage(m_session, "Server Revision: |r%sAscEmu r%u/%s-%s-%s %s(www.ascemu.org)", MSG_COLOR_WHITE, BUILD_HASH_STR, CONFIG, PLATFORM_TEXT, ARCH, MSG_COLOR_LIGHTBLUE);
